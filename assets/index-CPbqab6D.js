import{c as u,r as i,j as e,a as g,E as b,i as f,v as l,D as y,f as v,h as w,o as j,b as k,p as T,q as N,s as c,t as S,L as C}from"./index-Cfj_xNHZ.js";const I={Wrapper:u.section`
        margin-bottom: 30px;
...
200 OK
{
  "page": 2,
  "items": [...]
}`,pitfalls:["Server memory based state breaks horizontal scaling.","Hidden state makes bugs hard to reproduce."]},{key:"resourceBased",title:"Resources, not actions",icon:e.jsx(f,{}),summary:"REST is about resources. Use nouns in URLs. Use HTTP methods for actions.",points:["Use /users, /orders, /products as resources.","Use methods - GET read, POST create, PUT replace, PATCH update, DELETE remove.","Avoid verbs in URL like /getUsers or /createOrder."],mentalModel:"URL names the thing. HTTP method describes what you want to do with the thing.",example:`POST /orders
{
  "productId": 10,
  "qty": 2
}
...
200 OK
{
  ...
  "limit": 20,
  "total": 240
}`,pitfalls:["Inconsistent parameter names confuse clients.","Changing response shapes randomly causes frontend breakage."]},{key:"cacheable",title:"Cacheable responses",icon:e.jsx(y,{}),summary:"Responses should declare if they can be cached. Caching improves speed and reduces server load.",points:["Safe reads like GET are often cacheable if data is not user specific.","Use Cache-Control and ETag when relevant.","Caching is not only CDN. Browser caching is also valuable."],mentalModel:"If many people ask the same question, keep the answer on the wall so you do not repeat yourself.",example:`GET /public/products
