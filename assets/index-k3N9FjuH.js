import{c as m,r as i,j as e,J as h,z as u,n as g,v as b,K as y,o as v,b as w,p as j,q as k,s as l,t as N,F as B,y as T}from"./index-BfYXeRa6.js";const F={Wrapper:m.section`
        margin-bottom: 30px;
    ...
    `},S=()=>{const[o,c]=i.useState(!1),[d,n]=i.useState(null),x=i.useMemo(()=>[{key:"whatIs",title:"What is a Buffer",icon:e.jsx(h,{}),summary:"A Buffer is a Node.js type used to store raw binary bytes. It is how Node represents data from files, sockets, and streams.",bullets:["A string is text. A Buffer is bytes.","Buffers are used for network protocols, file I/O, images, audio, and any non-text payload.","When Node receives data from streams, you often get Buffer chunks."],mentalModel:{title:"Mental model",text:"A Buffer is a box of bytes. You can interpret those bytes as text using an encoding, but the inside is always raw bytes."}},{key:"create",title:"Creating buffers",icon:e.jsx(u,{}),summary:"Buffers can be created from strings, allocated with a size, or created from an array of bytes.",bullets:["Buffer.from creates a Buffer from a string or array.","Buffer.alloc creates a zero-filled Buffer of a fixed size.","Buffer.allocUnsafe is faster but may contain old memory. Use it only when you overwrite the buffer fully."],example:{title:"Examples - from and alloc",code:`// from string
