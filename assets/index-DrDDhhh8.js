import{c as u,r as t,j as e,S as l,B as g,a as f,f as y,A as b,R as v,t as w,y as k,p as j,q as T,s as c,F as N,w as R}from"./index-w7GzmdvE.js";const C={Wrapper:u.section`
        margin-bottom: 30px;
...
// Higher hit rate usually means lower DB load.`,pitfalls:["A high hit rate is good, but not if it serves wrong or stale data for business critical flows."]}],[]),m=()=>{d(a=>!a),r&&n(null)},h=a=>{n(s=>s===a?null:a)};return e.jsxs(C.Wrapper,{children:[e.jsxs("button",{type:"button",className:`sectionHeader ${r?"open":""}`,onClick:m,"aria-expanded":r,title:r?"Collapse Redis":"Expand Redis",children:[e.jsxs("span",{className:"left",children:[e.jsx("span",{className:"sIcon",children:e.jsx(k,{})}),e.jsxs("span",{className:"text",children:[e.jsx("span",{className:"title",children:"Redis"}),e.jsx("span",{className:"sub",children:"Cache, TTL, rate limiting, stampede protection, and production habits"})]})]}),e.jsxs("span",{className:"right",children:[e.jsx("span",{className:"pill",children:r?e.jsxs(e.Fragment,{children:[e.jsx(j,{})," Collapse"]}):e.jsxs(e.Fragment,{children:[e.jsx(T,{})," Expand"]})}),e.jsx("span",{className:`chev ${r?"rot":""}`,children:e.jsx(c,{})})]})]}),e.jsxs("div",{className:`sectionBody ${r?"show":""}`,children:[e.jsxs("div",{className:"intro",children:[e.jsx("div",{className:"introIcon",children:e.jsx(l,{})}),e.jsxs("div",{className:"introText",children:[e.jsx("div",{className:"introTitle",children:"Why Redis matters in backend systems"}),e.jsx("div",{className:"introSub",children:"Redis reduces database load, speeds up hot paths, enables rate limiting, and supports simple realtime counters. Learn a few patterns well and you will use them everywhere."})]})]}),e.jsx("div",{className:"grid",children:x.map(a=>{const s=p===a.key;return e.jsxs("div",{className:`card ${s?"open":""}`,children:[e.jsxs("button",{type:"button",className:"cardHeader",onClick:()=>h(a.key),"aria-expanded":s,title:s?`Collapse ${a.title}`:`Expand ${a.title}`,children:[e.jsxs("span",{className:"cLeft",children:[e.jsx("span",{className:"cIcon",children:a.icon}),e.jsxs("span",{className:"cText",children:[e.jsx("span",{className:"cTitle",children:a.title}),e.jsx("span",{className:"cSummary",children:a.summary})]})]}),e.jsx("span",{className:"cRight",children:e.jsx("span",{className:`cChev ${s?"rot":""}`,children:e.jsx(c,{})})})]}),e.jsxs("div",{className:`cardBody ${s?"show":""}`,children:[e.jsxs("div",{className:"block",children:[e.jsx("div",{className:"blockTitle",children:"Key points"}),e.jsx("ul",{className:"list",children:a.points.map((o,i)=>e.jsxs("li",{children:[e.jsx("span",{className:"dot"}),e.jsx("span",{className:"liText",children:o})]},`${a.key}-p-${i}`))})]}),e.jsxs("div",{className:"block",children:[e.jsx("div",{className:"blockTitle",children:"Mental model"}),e.jsx("p",{className:"para",children:a.mentalModel})]}),e.jsxs("div",{className:"block",children:[e.jsx("div",{className:"blockTitle",children:a.exampleTitle}),e.jsx("pre",{className:"code",children:e.jsx("code",{children:a.code})})]}),e.jsxs("div",{className:"block warn",children:[e.jsx("div",{className:"blockTitle",children:"Common pitfalls"}),e.jsx("ul",{className:"list",children:a.pitfalls.map((o,i)=>e.jsxs("li",{children:[e.jsx("span",{className:"dot"}),e.jsx("span",{className:"liText",children:o})]},`${a.key}-x-${i}`))})]}),e.jsxs("div",{className:"footerHint",children:[e.jsx("span",{className:"hintIcon",children:e.jsx(N,{})}),e.jsxs("span",{className:"hintText",children:["Revision tip: Explain ",a.title," in 2 lines and give 1 real example from production."]})]})]})]},a.key)})}),e.jsxs("div",{className:"closing",children:[e.jsx("span",{className:"closingIcon",children:e.jsx(R,{})}),e.jsx("span",{className:"closingText",children:"Rule: Cache makes things fast. Correctness comes first. Always plan staleness, invalidation, and fallback when Redis is unavailable."})]})]})]})};export{I as R};
