import{c as h,r as i,j as e,i as u,k as g,l as b,m as f,n as v,o as y,a as w,b as j,p as k,q as T,s as l,t as N,F as E,h as A}from"./index-w7GzmdvE.js";import{R as S}from"./index-DHBU2K0j.js";import{V as I}from"./index-C6OY_iKb.js";import{S as F}from"./index-FTURBv2q.js";const C={Wrapper:h.section`
        margin-bottom: 30px;
...
{ "id": "u1", "name": "Ashish", "role": "admin" }`},gotchas:["Do not version for every tiny change. Version only for breaking changes.","Avoid removing fields. Mark them deprecated and keep them for a while."]}],[]),x=()=>{c(r=>!r),s&&n(null)},m=r=>{n(a=>a===r?null:r)};return e.jsxs(C.Wrapper,{children:[e.jsxs("button",{type:"button",className:`sectionHeader ${s?"open":""}`,onClick:x,"aria-expanded":s,children:[e.jsxs("span",{className:"left",children:[e.jsx("span",{className:"sIcon",children:e.jsx(j,{})}),e.jsxs("span",{className:"text",children:[e.jsx("span",{className:"title",children:"API design"}),e.jsx("span",{className:"sub",children:"REST, naming, pagination, sorting, status codes, errors, versioning"})]})]}),e.jsxs("span",{className:"right",children:[e.jsx("span",{className:"pill",children:s?e.jsxs(e.Fragment,{children:[e.jsx(k,{})," Collapse"]}):e.jsxs(e.Fragment,{children:[e.jsx(T,{})," Expand"]})}),e.jsx("span",{className:`chev ${s?"rot":""}`,children:e.jsx(l,{})})]})]}),e.jsxs("div",{className:`sectionBody ${s?"show":""}`,children:[e.jsxs("div",{className:"intro",children:[e.jsx("div",{className:"introIcon",children:e.jsx(N,{})}),e.jsxs("div",{className:"introText",children:[e.jsx("div",{className:"introTitle",children:"What great API design is"}),e.jsx("div",{className:"introSub",children:"A great API is predictable, consistent, and safe under real-world usage. It should be easy to consume, hard to misuse, and stable over time."})]})]}),e.jsx("div",{className:"grid",children:p.map(r=>{const a=d===r.key;return e.jsxs("div",{className:`card ${a?"open":""}`,children:[e.jsxs("button",{type:"button",className:"cardHeader",onClick:()=>m(r.key),"aria-expanded":a,children:[e.jsxs("span",{className:"cLeft",children:[e.jsx("span",{className:"cIcon",children:r.icon}),e.jsxs("span",{className:"cText",children:[e.jsx("span",{className:"cTitle",children:r.title}),e.jsx("span",{className:"cSummary",children:r.summary})]})]}),e.jsx("span",{className:"cRight",children:e.jsx("span",{className:`cChev ${a?"rot":""}`,children:e.jsx(l,{})})})]}),e.jsxs("div",{className:`cardBody ${a?"show":""}`,children:[e.jsxs("div",{className:"block",children:[e.jsx("div",{className:"blockTitle",children:"Key points"}),e.jsx("ul",{className:"list",children:r.bullets.map((o,t)=>e.jsxs("li",{children:[e.jsx("span",{className:"dot"}),e.jsx("span",{className:"liText",children:o})]},`${r.key}-b-${t}`))})]}),e.jsxs("div",{className:"block",children:[e.jsx("div",{className:"blockTitle",children:r.mentalModel.title}),e.jsx("p",{className:"para",children:r.mentalModel.text})]}),e.jsxs("div",{className:"block",children:[e.jsx("div",{className:"blockTitle",children:r.example.title}),e.jsx("pre",{className:"code",children:e.jsx("code",{children:r.example.code})})]}),e.jsxs("div",{className:"block warn",children:[e.jsx("div",{className:"blockTitle",children:"Common pitfalls"}),e.jsx("ul",{className:"list",children:r.gotchas.map((o,t)=>e.jsxs("li",{children:[e.jsx("span",{className:"dot"}),e.jsx("span",{className:"liText",children:o})]},`${r.key}-g-${t}`))})]}),e.jsxs("div",{className:"footerHint",children:[e.jsx("span",{className:"hintIcon",children:e.jsx(E,{})}),e.jsx("span",{className:"hintText",children:"Revision tip: Say the best status codes for create, update, delete, and validation errors."})]})]})]},r.key)})}),e.jsxs("div",{className:"closing",children:[e.jsx("span",{className:"closingIcon",children:e.jsx(A,{})}),e.jsx("span",{className:"closingText",children:"Consistency beats perfection. A predictable API is easier to scale, test, secure, and maintain."})]})]})]})},D=()=>e.jsxs(e.Fragment,{children:[e.jsx(R,{}),e.jsx(S,{}),e.jsx(I,{}),e.jsx(F,{})]});export{D as default};
